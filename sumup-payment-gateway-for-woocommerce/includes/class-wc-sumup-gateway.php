...
class WC_Gateway_SumUp extends \WC_Payment_Gateway {
	...
	public function add_payment_instructions_thankyou_page( $order_id ) {
		...
		?>
			...
			<style>
				#sumup-boleto-code{background:#ececec;padding:4px;font-weight:700}
			</style>
